...
more=here"
    ...
    run -99 containedOrUpdateIniConfig --section default --key foo --value bar <<<"$INPUT"
...
foo=bar"
    UPDATE="foo=new"
    export MEMOIZEDECISION_CHOICE=n
    run -98 containedOrUpdateIniConfig --section default --key foo --value new - <<<"$INPUT"
...
foo=bar"
    ...
    run -0 containedOrUpdateIniConfig --section default --key foo --value new - <<<"$INPUT"

...
@test "asks again on confirm each" {
    ...
    run -0 containedOrUpdateAssignment --memoize-group containedOrUpdateAssignment --in-place --lhs foo --rhs new "$FILE"
...
@test "does not recall another file on yes" {
    ...
    run -0 containedOrUpdateAssignment --memoize-group containedOrUpdateAssignment --in-place --lhs foo --rhs new "$FILE2"

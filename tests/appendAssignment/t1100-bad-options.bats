...
@test "error when combining --ignore-nonexisting and --create-nonexisting" {
    run -2 appendAssignment --ignore-nonexisting --create-nonexisting --lhs foo --rhs new "$FILE"
...
@test "error when combining --add-before and --add-after" {
    run -2 appendAssignment --add-before 4 --add-after 6 --lhs foo --rhs new "$FILE"
